 ...
 * @param {Uint8Array} zkir_bytes
 * @param {any} provider
 * @returns {Promise<KeygenResult>}
 */
export function keygen(zkir_bytes, provider) {
    const ret = wasm.keygen(zkir_bytes, provider);
    return ret;
}
 ...
 */
export function keygenMany(entries, provider, progress) {
    const ret = wasm.keygenMany(entries, provider, progress);
    return ret;
}
 ...
 * @returns {Promise<KeygenResult>}
 */
export function keygenFromJson(json, provider) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.keygenFromJson(ptr0, len0, provider);
    return ret;
}
 ...
 * @returns {number}
 */
export function getCircuitK(zkir_bytes) {
    const ret = wasm.getCircuitK(zkir_bytes);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0];
 ...
 * @returns {number}
 */
export function getCircuitKFromJson(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.getCircuitKFromJson(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0];
...
function __wbg_adapter_90(arg0, arg1, arg2, arg3) {
    wasm.closure866_externref_shim(arg0, arg1, arg2, arg3);
}
...
const KeygenResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_keygenresult_free(ptr >>> 0, 1));
/**
...
export class KeygenResult {
     ...
     */
    get proverKey() {
        const ret = wasm.keygenresult_proverKey(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {Uint8Array}
     */
    get verifierKey() {
        const ret = wasm.keygenresult_verifierKey(this.__wbg_ptr);
        return ret;
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_keygenresult_new = function(arg0) {
        const ret = KeygenResult.__wrap(arg0);
        return ret;
    };
    ...
    imports.wbg.__wbindgen_cast_bec355616b93886f = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, 801, __wbg_adapter_8);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('midnight_zkir_keygen_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
